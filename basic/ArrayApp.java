...
public class ArrayApp {
	public static void main(String[] args) {
		...
		//배열 요소를 구분하는 첨자를 잘못 사용한 경우 ArrayIndexOutOfBoundsException
		...
		//for 구문을 이용하여 배열에 대한 일괄 처리 : 첨자 이용(입력, 처리, 출력 가능)
		...
		//for 구문을 이용하여 배열에 대한 일괄 처리 : 반복지시자 이용(처리, 출력 가능)
		for(int temp : su) {
