...
public class StaticBlockApp {
	public static void main(String[] args){
		...
		*/
		...
		//ClassLoad 프로그램을 이용하여 메모리에 저장하는 메모리에 저장하는 메소드
		//=> 메모리에 저장된 클래스 정보(Class 인스턴스 - Clazz) 반환
		//=> ClassNotFoundException 발생 - 예외처리
		//Class.newInstance() : 메모리에 저장된 클래스(Clazz)의 생성자를 이용하여 인스턴스를 생성하는 메소드
		...
		/*
		try {
			StaticBlock sb=(StaticBlock)Class.forName("site.itwill.jdbc.StaticBlock").newInstance();
			sb.display();
