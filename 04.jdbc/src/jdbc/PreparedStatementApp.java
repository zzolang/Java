...
//PreparedStatementApp 인스턴스 : 접속된 DBMS 서버에 SQL 명령을 전달하여 실행결과를
//반환하는 기능을 제공하는 인스턴스
//장점 : SQL 명령에 InParameter를 사용하여 값을 전달받아 사용 - 동적 SQL 명령
//=> 미리 저장된 SQL 명령을 전달하므로 가독성이 좋으며 유지보수의 효율성이 높다
//=> InSQL 해킹 공격을 무효화 - 전달값이 SQL 명령으로 미포함
...
public class PreparedStatementApp {
	public static void main(String[] args) throws Exception {
		...
		//키보드로 학생정보를 입력받기 위한 입력스트림 생성
				...
				//prepareStatement 인스턴스를 반환하는 메소드
				//=> PreparedStatement 인스턴스에는 저장된 SQL 명령에는 ?(InParameter) 사용
				//InParameter : Java 변수값을 Oracle 상수로 표현하기 위한 기호
				...
				//PreparedStatement.executeUpdate() : PreparedStatement 인스턴스에 저장된
				//SQL 명령(DML)을 전달하여 실행하는 메소드 - 조작행의 갯수 반환
		...
		//키보드로 이름을 입력받아 STUDENT 테이블에 저장된 STUDENT 
		//테이블에 저장된 모든 학생정보를 검색하여 출력하는 프로그램
