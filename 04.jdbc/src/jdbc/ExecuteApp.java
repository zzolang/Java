...
public class ExecuteApp {
	public static void main(String[] args) throws SQLException {
		 ...
		 * System.out.println("==============================================");
		 * 
		 * String sql2="select * from student order by no"; ResultSet
		...
		if(result) { //DQL 명령이 전달된 경우
			//Statement.getResultSet() : 전달되어 실행된 SELECT 명령에 대한 
			//검색결과(ResultSet 인스턴스)를 반환하는 메소드
			...
			//Statement.getUpdateCount() : 전달되어 실행된 INSERT, UPDATE, DELETE 명령에 대한 
			//명령에 대한 조작행의 갯수를 반환하는 메소드
