...
public class MemberEvent extends Member{
	...
	*/
	...
	public MemberEvent() { // 보이지는 않지만 Member super, MemberEvent this 가 들어가 있음
	...
	public MemberEvent(String id, String name, String email) {
		//super();
		//메소드에서 필드(메소드)에 접근 할 경우 자식클래스에서 검색하여 접근하고
		//없는 경우에는 부모클래스에서 검색하여 접근
	...
	*/
	...
	// => *** 부모클래스의 메소드는 숨겨지고 (hide method) 자식클래스의 메소드만 호출가능 ***
