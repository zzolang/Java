...
public class EmployeeApp {
	public static void main(String[] args) {
		...
		*/
		...
		employeeArray[0]=new EmployeeReguler(1000, "홍길동", 96_000_000);
		employeeArray[1]=new EmployeeTime(2000, "임꺽정", 50_000, 150);
		employeeArray[2]=new EmployeeContract(3000, "전우치", 7_000_000);
		employeeArray[3]=new EmployeeTime(4000, "일지매", 10_000, 100);
		employeeArray[4]=new EmployeeReguler(5000, "장길산", 60_000_000);
		...
		for(Employee employee:employeeArray) {
			...
			/*
			//사원 급여 출력 - 명시적 객체형변환을 이용하여 자식 인스턴스의 메소드 호출
			// => instanceof 연산자를 이용하여 자식 클래스를 구분 후 형변환
