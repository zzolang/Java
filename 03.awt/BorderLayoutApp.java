...
//배치관리자(LayoutManager) : 컴퍼넌트의 출력 위치와 크기를 자동으로 변경하여 부착하는 기능을 제공하는 클래스
// => BorderLayout, FlowLayout, GridLayout 등

//모든 컨테이너에는 기본적으로 컴퍼넌트 부착하는 배치관리자가 기본적으로 설정
...
public class BorderLayoutApp extends Frame{
	...
	public BorderLayoutApp(String title) {
		...
		*/
		...
		//원하는 위치에 부착하는 메소드 - index 대신 BorderLayout 클래스의 상수필드
