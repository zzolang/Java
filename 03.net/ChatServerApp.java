...
// => 클라이언트와 연결된 소켓은 새로운 스레드를 이용하여 독립적인 명령 실행
	...
	public class SocketThread extends Thread {
		...
		public void run() {
			...
			try {
				...
				// 클라이언트에서 보내온 메세지를 반환받아 현재 접속된
				// 모든 클라이언트에게 전달 - 클라이언트가 접속 종료 전까지 반복
				...
				System.out.println("[해제로그]" + socket.getInetAddress().getHostAddress() + "의 컴퓨터에서 접속을 해제 하였습니다.");
