...
public class IfExample {
	public static void main(String[] args) {
		...
		if(kor<0 || kor>100 || eng<0 || eng>100 || mat<0 || mat>100) {
			System.out.println("[에러]0~100 범위를 벗어난 점수가 입력되었습니다.");
			System.exit(0); // 프로그램 강제 종료 메소드
		}
		*/
		//점수에 입력 유효성 검사 관련 상태정보를 저장하기 위한 변수
		boolean status=false;
		
		if(kor<0 || kor>100) {
			System.out.println("[에러]0~100 범위를 벗어난 국어점수가 입력되었습니다.");
			status=true;
		}
		
		if(eng<0 || eng>100) {
			System.out.println("[에러]0~100 범위를 벗어난 영어점수가 입력되었습니다.");
			status=true;
		}
		
		if(mat<0 || mat>100) {
			System.out.println("[에러]0~100 범위를 벗어난 수학점수가 입력되었습니다.");
			status=true;
		}
		...
		System.out.println("평균 = "+(int)(avg*100)/100.+" >> "+grade+"학점 입니다." );
		} else {
			System.out.println("[에러]0~100 범위를 벗어난 점수가 입력되었습니다.");
			System.exit(0);
