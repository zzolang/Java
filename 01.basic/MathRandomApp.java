...
public class MathRandomApp {
	public static void main(String[] args) {
		...
		for(int i=1;i<=5; i++) {
			System.out.println(i+"번째 실수 난수 = "+Math.random());
		}
		System.out.println("============================================");
		
		//0~99 범위의 정수난수를 제공받아 출력
		for(int i=1;i<=5; i++) {
			System.out.println(i+"번째 정수 난수(0~99) = "+(int)(Math.random()*100));
		}
		System.out.println("============================================");
		
		//1~45 범위의 정수난수를 제공받아 출력
		for(int i=1;i<=5; i++) {
			System.out.println(i+"번째 정수 난수(1~45) = "+(int)(Math.random()*100%45+1));
		}
		System.out.println("============================================");
	}
